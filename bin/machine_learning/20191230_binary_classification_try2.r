...
# Confusion matrix
getTrainPerf(rf) # Training set accuracy is 80.5% for random forest
...
cm_rf # 80.95% accuracy

sink("output/machine_learning/random_forest_12angstroms_binary_classification_results.txt")
cm_rf
sink()
...
pllist[[1]]
ggsave("output/machine_learning/nb_12angstroms_activity_binary_classification_matrix_20191230.jpeg", height=7, width=7, units='in')
...
pllist[[1]]
ggsave("output/machine_learning/nnet_12angstroms_activity_binary_classification_matrix_20191230.jpeg", height=7, width=7, units='in')
...
pllist[[1]]
ggsave("output/machine_learning/svm_radial_conf_matrices_12angstroms_activity_binary_classification_20191230.jpeg", height=7, width=7, units='in')
