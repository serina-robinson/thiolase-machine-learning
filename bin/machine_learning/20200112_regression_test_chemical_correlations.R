...
# corrdf <- dat %>%
#   dplyr::select(PC2, activity, VC.5, VC.3, Kier3, Kier2, nRotB, nAtomLC)
# chart.Correlation(corrdf)
# 
# cor.test(dat$PC2, dat$activity)
# cor.test(dat$nRotB, dat$activity)
# cor.test(dat$nAtomLC, dat$activity)
