...
# Read in the data
fils <- list.files("data/C6_control/", pattern = "20190921", full.names = T)
fils
...
B2=rowMeans(Table[,c("F", "F11", "F12")]-Blank)
...
write_csv(chain.melt, "data/C6_control/2019-09-21_whole_cell_JGI_1_melted.csv")

chain_SD=data.frame(Time,F2.sd,C5.sd,A4.sd,B4.sd,OleA.sd,B5.sd,D2.sd,G2.sd,B3.sd,D3.sd,E3.sd,F3.sd,G3.sd,H3.sd,C4.sd,D4.sd,E4.sd,F4.sd,G4.sd,H4.sd,A5.sd,B5.sd,D5.sd,E5.sd,F5.sd,G5.sd,H5.sd,A6.sd,B6.sd)
chain_SD.melt=melt(chain_SD, id.vars="Time")



Chain.ymin=chain.melt$value - c
Chain.ymax=chain.melt$value
