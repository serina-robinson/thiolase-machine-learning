...
hept <- read_csv('output/2019-10-25/2019-10-25_heptynoate_all_data_calculated_slopes.csv') %>%
...
write_csv(temp_org, "output/scratch_output/left_right_comparison.csv")
