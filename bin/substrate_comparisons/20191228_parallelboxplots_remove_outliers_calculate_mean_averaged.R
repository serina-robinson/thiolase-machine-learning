...
pdf("output/scratch_output/20191218_boxplots_with_means_sorted_by_date_avged.pdf", width = 6, height = 6)
...
maprdat_activ <- maprdat_long %>%
  dplyr::mutate(activity_level = case_when(log_slope >= mean_slope ~ "high",
                                           TRUE ~ "low"))


table(maprdat_activ$activity_level)
write_csv(maprdat_activ, "data/machine_learning/20191228_enzyme_activity_level.csv")
