...
ll <- ll[!grepl("BocPhe|furf|scratch|only|averaged|benzoate|round|C6", ll)] # rep1|rep2|reps|round|
ll
...
pdf("output/substrate_comparisons/substrate_comparison_heatmap_unclustered_transposed_log10_scale_per_hr_no_cutoff.pdf", width = 13, height = 8)
pheatmap(
  cluster_cols = F,
 # cluster_rows = F,
  border_color = NA,
