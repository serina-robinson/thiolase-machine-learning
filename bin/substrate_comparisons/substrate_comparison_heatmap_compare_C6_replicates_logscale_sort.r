...
# write_csv(maprdat_long, "output/C6_all_slopes.csv")
...
pdf("output/substrate_comparisons/substrate_comparison_heatmap_unclustered_C6_only_log10_scale_per_hr_no_cutoff.pdf", width = 3.5, height = 9)
pheatmap(
  cluster_cols = T,
  cluster_rows = T,
  border_color = NA,
