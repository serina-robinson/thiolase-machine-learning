...
maprdat_wide[is.na(maprdat_wide)] <- 1e-9
...
pdf("output/substrate_comparisons/substrate_comparison_heatmap_clustered_full_numbered.pdf", width = 6, height = 9)
pheatmap(
  border_color = NA,
  mat = dedup, 
  breaks = mat_breaks,
...
pdf("output/substrate_comparisons/substrate_comparison_heatmap_clustered_full_transposed.pdf", width = 12, height = 6)
pheatmap(
  border_color = NA,
  mat = t(dedup), 
  breaks = mat_breaks,
